...
//     // 👉 Make dark mode default on first render
//     useEffect(() => {
...
//                         >
//                             <img src={"/img/profile.png" || user?.avatar} alt="mdo" width="50" height="50" className="rounded-circle" />
//                         </a>

//                         <ul
//                             className={`dropdown-menu ${isOpen ? 'show' : ''}`}
//                             style={isOpen ? { position: 'absolute', inset: '0px 0px auto auto', margin: '0px', transform: 'translate3d(0px, 34px, 0px)' } : {}}
//                         >
//                             <li>
...
//                             >
//                                 <img
//                                     src={"/img/profile.png" || user?.avatar}
//                                     alt="profile"
//                                     width="50"
//                                     height="50"
